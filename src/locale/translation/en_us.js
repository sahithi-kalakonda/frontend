const lang = {
  ...
  notes: 'Notes',
  help: 'Help',
  walking: 'Walking in mins',
  cycling: 'Cycling in mins',
  threadmill: 'Threadmill in mins',
  yoga: 'Yoga in mins',
  ...
  employee_list: 'Daily Workout',
  add_new_employee: 'Add Workout Summary',
  ...
  unpaid: 'Unpaid',
  value: 'Value',
  active_customer: 'Active User',
  customer_preview: 'User Preview',
  new_customer_this_month: 'New User This Month',
